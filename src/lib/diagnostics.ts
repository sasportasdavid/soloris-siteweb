 ...
 *
 * Prix : tirés de `ADDON_PRICE` (src/lib/pricing.ts) — aucune valeur en dur ici.
 */
import { ADDON_PRICE } from './pricing';
...
export const DIAGNOSTICS: Diagnostic[] = [
  {
    ...
    metaDesc:
      `Diagnostic amiante pour la vente : repérage des matériaux amiantés (permis avant juillet 1997). Tarif tout compris dès ${ADDON_PRICE.amiante} €, certifié COFRAC.`,
    h1: 'Diagnostic amiante',
    tagline: 'Le repérage des matériaux susceptibles de contenir de l’amiante.',
    priceLabel: `dès ${ADDON_PRICE.amiante} €`,
    intro:
    ...
    faq: [
      ...
      { q: 'Combien coûte un diagnostic amiante ?', a: `Dès ${ADDON_PRICE.amiante} € tout compris, déplacement inclus. Il est généralement réalisé avec les autres diagnostics du pack vente.` },
  ...
  },
  {
    ...
    metaDesc:
      `Constat de risque d’exposition au plomb (CREP) pour les logements avant 1949, vente et location. Tarif tout compris dès ${ADDON_PRICE.plomb} €, certifié COFRAC.`,
    h1: 'Diagnostic plomb (CREP)',
    tagline: 'Le constat de risque d’exposition au plomb, pour les logements anciens.',
    priceLabel: `dès ${ADDON_PRICE.plomb} €`,
    intro:
    ...
    faq: [
      ...
      { q: 'Combien coûte un diagnostic plomb ?', a: `Dès ${ADDON_PRICE.plomb} € tout compris, déplacement inclus. Il s’intègre au pack vente ou location selon votre projet.` },
  ...
  },
  {
    ...
    metaDesc:
      `Diagnostic électricité pour les installations de plus de 15 ans, vente et location. Réalisé avec le gaz (${ADDON_PRICE.elec_gaz} € le combo), certifié COFRAC.`,
    h1: 'Diagnostic électricité',
    tagline: 'L’état de l’installation intérieure d’électricité.',
    priceLabel: `${ADDON_PRICE.elec_gaz} € (électricité + gaz)`,
    intro:
  ...
  },
  {
    ...
    metaDesc:
      `Diagnostic gaz pour les installations de plus de 15 ans, vente et location. Réalisé avec l’électricité (${ADDON_PRICE.elec_gaz} € le combo), certifié COFRAC.`,
    h1: 'Diagnostic gaz',
  ...
  },
  {
    ...
    metaDesc:
      `Mesurage Loi Carrez : surface privative d’un lot de copropriété pour la vente. Tarif tout compris dès ${ADDON_PRICE.carrez_boutin} €, certifié COFRAC.`,
    h1: 'Mesurage Loi Carrez',
    tagline: 'La surface privative d’un lot en copropriété, pour la vente.',
    priceLabel: `dès ${ADDON_PRICE.carrez_boutin} €`,
    intro:
  ...
  },
  {
    ...
    metaDesc:
      `Mesurage Loi Boutin : surface habitable pour le bail de location. Tarif tout compris dès ${ADDON_PRICE.carrez_boutin} €, certifié COFRAC.`,
  ...
  },
  {
    ...
    metaDesc:
      `État des Risques et Pollutions (ERP) : risques naturels, miniers et technologiques, vente et location. ${ADDON_PRICE.erp} € · offert dans nos packs, certifié COFRAC.`,
    h1: 'État des Risques et Pollutions (ERP)',
    tagline: 'L’information sur les risques auxquels le bien est exposé.',
    priceLabel: `${ADDON_PRICE.erp} € · offert en pack`,
    intro:
    ...
    inPack: ['vente', 'location'],
    faq: [
      { q: 'L’ERP est-il payant chez Soloris ?', a: `Il est offert dans nos packs vente et location. À l’unité, il est proposé à ${ADDON_PRICE.erp} €.` },
