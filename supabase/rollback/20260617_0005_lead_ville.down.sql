-- ============================================================================
-- Rollback Migration 5 — Ville du bien (Soloris)
-- Restaure upsert_lead sans `ville` (état migration 4) puis supprime la colonne.
-- ============================================================================
...
alter table public.leads drop column if exists ville;
